    ...
    <section id="available-assays" className="bg-[#f7fbfd] px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="mb-2 text-sm font-semibold uppercase text-[#1582b8]">Available panels</p>
        ...
        {products.length === 0 ? (
          <div className="rounded-md border border-dashed border-[#b8cfdd] bg-white px-6 py-12 text-center">
            <p className="text-[#526b7c]">No assay panels found yet. Add products and assay details from the admin panel.</p>
          </div>
        ) : (
