...
#
# Use MySQL by default so the backend connects to the provided database
# credentials unless the environment explicitly overrides this behavior.
USE_MYSQL = _env_bool("USE_MYSQL", "True") or os.getenv("DB_ENGINE", "").lower() in (
    "mysql",
